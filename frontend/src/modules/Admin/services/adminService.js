...
export const downloadProductTemplate = async (format = 'excel', workspace = null) => {
    const params = workspace ? { workspace } : {};
    const response = await api.get(`/admin/products/template/${format}`, { params, responseType: 'blob' });
